...
export function PathsGallery({ open, onClose, onStartQuiz }) {
  const [query, setQuery] = React.useState("");

  const cards = [
    {
      key: "exobotany",
      title: "Exobotany • Green Habitats",
      tag: "plants",
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-5 pr-1 overflow-y-auto max-h-[62vh]">
              {filtered.map((c, idx) => (
                ...
                >
                  <div className="p-5">
                    <div
                      className={`absolute inset-0 pointer-events-none opacity-0 hover:opacity-100 transition bg-gradient-to-br ${c.color}/15`}
                    />
            ...
            {/* 🔻 marquee (placed before the ending bar) */}
